(function (global, factory) {
  ...
  */
  ...
  function computeAccessibleName(root) {
    ...
    function computeMiscTextAlternative(node, context) {
      ...
      var childNodes = arrayFrom(node.childNodes).concat(idRefs(node, "aria-owns"));
      childNodes.forEach(function (child) {
        ...
        var display = isElement(child) ? createGetComputedStyle(child, options // eslint-disable-next-line no-mixed-spaces-and-tabs -- prettier bug?
  ...
  */
  ...
  function _createForOfIteratorHelperLoose(o) { var i = 0; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (o = _unsupportedIterableToArray$2(o))) return function () { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }; throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } i = o[Symbol.iterator](); return i.next.bind(i); }
  ...
  function makeSuggestion(queryName, content, _ref) {
    var _ref$variant = _ref.variant,
        variant = _ref$variant === void 0 ? 'get' : _ref$variant,
        name = _ref.name;
    var queryArgs = [content];

    if (name) {
      queryArgs.push({
        name: new RegExp(escapeRegExp(name.toLowerCase()), 'i')
      });
    }
    ...
    return {
      ...
      toString: function toString() {
        var options = queryArgs[1] ? ", { " + Object.entries(queryArgs[1]).map(function (_ref2) {
          var k = _ref2[0],
              v = _ref2[1];
          return k + ": " + v;
        }).join(', ') + " }" : '';
